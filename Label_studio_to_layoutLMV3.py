...
# ── المسارات ──
TRAINING_DATA_DIR = r"E:\AI_MODOL\training_data"
DONE_DIR          = r"E:\AI_MODOL\انتهى_التعليم"
OUTPUT_JSON       = r"E:\AI_MODOL\training_data\Training_layoutLMV3.json"
...
for json_file in json_files:
	...
	for task in data:
		...
		data_item["file_name"] = os.path.join(r"E:\AI_MODOL\output_images", image_name)
		...
		# استخرج bbox + transcription + label
		if annotations:
			...
			for r in results:
				...
				# rectanglelabels مدمج مع rectangle
	...
	print(f"  ✅ Flyttet til انتهى_التعليم")
